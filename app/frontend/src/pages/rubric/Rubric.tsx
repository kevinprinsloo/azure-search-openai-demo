...
const RubricEvaluation = () => {
    ...
    const options = rubricCriteria.map(criteria => ({ value: criteria, label: criteria })); 
            ...
            <div className={styles.rubricWrapper}>
                ...
                <Select
                    ...
                    <table className={styles.table}>
                        ...
                        <tbody>
                            {responses.filter(item => !selectedCriteria || item.criterion === selectedCriteria).map((item, index) => (
                                <tr key={index}>
